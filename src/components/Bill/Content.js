...
export default function Content() {
    ...
    async function featchcouponList() {
        try {
            const requestURL = `http://www.cinemasystem2.somee.com/api/Coupon`;
    ...
    async function featchBillList() {
        try {
            ...
            const requestURL = `http://www.cinemasystem2.somee.com/api/Bill?AccountId=${accid}&CouponId=${Coupon.id == undefined ? "" : Coupon.label}`;
