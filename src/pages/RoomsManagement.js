...
import Content from 'components/RoomsManagement/Content';
import AdminTemplates from 'components/AdminTemplates';
import { React, useState, } from 'react';


export default function RoomsManagement(props) {
        ...
        <AdminTemplates>
            ...
            <div className='  ml-0 xl:ml-64  mt-28 text-white ' role="presentation" onClick={handleClick}>
                <Breadcrumbs className='pl-5' aria-label="breadcrumb">
                    ...
                    <Typography color="text.primary" className='underline'>Rooms Management</Typography>
                </Breadcrumbs>
            </div>
            <div className='mb-12'>
                <Content />
